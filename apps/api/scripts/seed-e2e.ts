...
async function main() {
  ...
  await prisma.$executeRawUnsafe(
    'TRUNCATE TABLE "AuditMaterial", "AuditApplication", "AuditLog", "Arbitration", "MarkRecord", "MarkingTask", "AllocationItem", "AllocationBatch", "RefreshToken", "EmailCode", "QuestionImage", "PaperQuestion", "PaperPage", "Paper", "MemberProfile", "Team", "UserAccount" RESTART IDENTITY CASCADE',
  );
