...
// 前置：以下账号需已存在（见下方 cases 数组）。除超管/管理员外，密码统一为 12312312。
//   创建方式：pnpm api:init-super-admin -- super 系统管理员 superadmin888
//             pnpm api:create-internal -- zhangsan 张三 12312312 CPHOS_MEMBER
//             pnpm api:create-internal -- lioper 李四 ops888 ADMIN
//   平台用户 coach.test@example.com 需经注册+邮箱验证流程创建（密码 12312312）。
...
const cases = [
  ...
  ['zhangsan', '12312312', { role: 'CPHOS_MEMBER', protected: false, displayName: '张三', profile: null }],
  ['lioper', 'ops888', { role: 'ADMIN', protected: false, displayName: '李四' }],
  ['coach.test@example.com', '12312312', { role: 'PLATFORM_USER', email: 'coach.test@example.com' }],
];
