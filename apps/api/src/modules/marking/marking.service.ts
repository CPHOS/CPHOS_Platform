...
export async function assertArbitrationAccess(userId: bigint, arbitrationId: bigint): Promise<void> {
        ...
        paper: {
          select: {
            ...
            student: {
              select: {
                schoolId: true,
                owner: { select: { userId: true, teamId: true, schoolId: true } },
              },
            },
          },
        },
  ...
  const conflict = hasArbitrationConflict({
    ...
    uploaderSchoolId: question.paper.uploadedBy.schoolId,
    studentOwnerUserId: question.paper.student.owner.userId,
    studentOwnerTeamId: question.paper.student.owner.teamId,
    studentOwnerSchoolId: question.paper.student.owner.schoolId,
    studentSchoolId: question.paper.student.schoolId,
