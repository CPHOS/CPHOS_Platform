...
const FEATURES: Feature[] = [
  { icon: <AuditOutlined />, title: '用户审核', desc: '审核注册用户提交的资料；老用户认领匹配旧账号' },
  { icon: <TeamOutlined />, title: '教练管理', desc: '角色调整、默认批阅槽位、上传限额（含切换前置检查）' },
  { icon: <FileExcelOutlined />, title: '字典维护', desc: '赛区 / 学校 / 年级 / 奖项 / 题号字典（旧库种子导入）' },
  { icon: <TrophyOutlined />, title: '考试与阅卷', desc: '批次配置、分配、仲裁、成绩与排名（M2）' },
];
